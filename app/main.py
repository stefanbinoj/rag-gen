...
from app.schemas.mongo_models import Model, Prompt, GenerationLog, ComprehensionLog, FillInTheBlankLog
...
def create_app() -> FastAPI:
    ...
    async def startup_event():
        db = get_mongo_db()
        await init_beanie(database=db, document_models=[Model, Prompt, GenerationLog, ComprehensionLog,FillInTheBlankLog ])  # pyright: ignore[reportArgumentType]
